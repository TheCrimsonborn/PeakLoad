...
const COPY = {
  en: {
    ...
    footerText: "peakloads keeps your training precise, intentional, and progressive.",
  ...
  tr: {
    ...
    footerText: "peakloads antrenmanınızı tutarlı, hedefli ve ilerlemeci tutar.",
  ...
  ru: {
    ...
    footerText: "peakloads помогает тренироваться точно, осознанно и прогрессивно.",
